...
ACTION_MAPPING_PATH = CURRENT_COMPONENT_PATH / "configuration/external_action_mapping.ini"

INTERNAL_ACTION_MAPPING_PATH = CURRENT_COMPONENT_PATH / "configuration/internal_action_mapping.ini"
...
CONFIGURATION_PATH_TEMPLATE = Template(
    str(CURRENT_COMPONENT_PATH / "configuration/model_definitions/$message_type") + f".{CONFIGURATION_FORMAT}"
)